...
func Example_Unmarshal() {
	...
	//Output:
	//[github.com/idiomatic-go/middleware/gotp/unmarshal [response or response body is nil]]
...
func Example_Decode() {
	...
	//Output:
	//[github.com/idiomatic-go/middleware/gotp/decode [response or response body is nil]]
